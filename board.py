...
class Board:
    ...
    def __init__(self) -> None:
        ...
        w, h = int(conf.w*0.98), int(conf.h*0.1)
        x = conf.w/2-w/2
        y = conf.h/2-h/2
        self.lblPauseNextLevel = Label("---", (x, y), (w, h))
        self.lblPauseNextLevel.visible = False
        ...
        self.lblPauseTimer = Label(
            "---", (conf.w/2-w, conf.h-h*4), (w*2, h*2))
    ...
    def draw(self, screen):
        ...
        self.lblPauseTimer.draw(screen)
